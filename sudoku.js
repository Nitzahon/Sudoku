...
let sudoku1, sudoku2, sudoku3;
// ... and we solve it!!
let sudoku = solve(new Array(81).fill(0));
//then we print
showSudoku(sudoku);

//then we remove cells and print
sudoku1 = removeCells(sudoku.slice(), easy);
showSudoku(sudoku1);
sudoku2 = removeCells(sudoku.slice(), medium);
showSudoku(sudoku2);
sudoku3 = removeCells(sudoku.slice(), hard);
showSudoku(sudoku3);
